...
import dev.agasen.api.user.user.UserModificationDetails;
import dev.agasen.api.user.user.UserPasswordChange;
import dev.agasen.api.user.user.UserRoleAssignmentDetails;
import dev.agasen.api.user.user.UserRolesDetails;
