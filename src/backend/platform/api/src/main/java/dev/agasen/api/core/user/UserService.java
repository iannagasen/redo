...
import dev.agasen.api.core.user.user.UserModificationDetails;
import dev.agasen.api.core.user.user.UserPasswordChange;
import dev.agasen.api.core.user.user.UserRoleAssignmentDetails;
import dev.agasen.api.core.user.user.UserRolesDetails;
